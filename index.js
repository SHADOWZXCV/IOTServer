...
server.listen(process.env.MODE === 'DEVELOPMENT' ? process.env.DEV_PORT : process.env.PROD_PORT, () => CONSOLE(`Server started at port ${process.env.MODE === 'DEVELOPMENT' ? process.env.DEV_PORT : process.env.PROD_PORT}`))